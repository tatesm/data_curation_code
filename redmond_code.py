...
hourly_dataframe_redmond = pd.DataFrame(data = hourly_data)
print(hourly_dataframe_redmond)
...
daily_dataframe_redmond = pd.DataFrame(data = daily_data)
print(daily_dataframe_redmond)